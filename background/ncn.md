...
For custom kernel parameters for resizing partitions or controling other behaviors from CSM: Metal's
...
For more information, see [dracut cmdline's network parameter definition][13] and the
